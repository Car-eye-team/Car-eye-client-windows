...
#include "ssqueue.h"
#ifdef _DEBUG
#pragma comment(lib, "EasyRTSPClient/libEasyRTSPClient-static-debug.lib")
#else
#pragma comment(lib, "EasyRTSPClient/libEasyRTSPClient-static.lib")
#endif
...
#ifdef _DEBUG
#pragma comment(lib, "libEasyAACEncoder/libEasyAACEncoder-static-debug.lib")
#else
#pragma comment(lib, "libEasyAACEncoder/libEasyAACEncoder-static.lib")
#endif

// 增加MP4box库的支持 [9/20/2016 dingshuai]
//gpac write mp4 file
#include "MP4Writer/MP4Writer.h"
